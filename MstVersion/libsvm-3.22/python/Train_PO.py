...
def CreateTrainFile():
    ...
    f=file("E:\\HP\\crops_p\\train_pix_feature_position.txt","w+")
    f.writelines(li)
    f.close()
def train_svm_model():
    ...
    from svmutil import *
    model_path='E:\\HP\\crops_p\\a.model'
    y, x = svm_read_problem('E:\\HP\\crops_p\\train_pix_feature_position.txt')
    model = svm_train(y, x)
...
def svm_model_test():
    ...
    from svmutil import *
    model_path='E:\\HP\\crops_p\\a.model'
    yt, xt = svm_read_problem('E:\\HP\\crops_p\\test.txt')
